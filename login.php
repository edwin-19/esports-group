        ...
        <div class="col-12 col-sm-8 col-md-4 mx-auto">
          <div class="card m-b-0">
            ...
            <div class="card-block">
              <form method="post">
                <a class="btn btn-social btn-facebook btn-block btn-icon-left" href="#" role="button">
                ...
                <div class="form-group input-icon-left m-b-10">
                  ...
                  <input type="email" name="txt_uname_email" class="form-control form-control-secondary" placeholder="Username">
                </div>

                <div class="form-group input-icon-left m-b-15">
                  <i class="fa fa-lock"></i>
                  <input type="password" name="txt_password" class="form-control form-control-secondary" placeholder="Password">
                </div>
                ...
                <a class="btn btn-secondary btn-block" href="register.php" role="button">
                  Register
                </a>
